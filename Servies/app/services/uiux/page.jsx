...
export default function UiUxDesignServices() {
     ...
     const sectionData = [
               ...
               },
               {
                 ...
                 description:
                   " We craft designs that actively guide user actions, turning interactions into measurable results.",
               ...
               },
               {
                 ...
                 description:
                   "  Our solutions evolve with your audience, creating seamless, data-driven experiences that grow over time.",
 ...
 <section id="home" className="flex flex-col items-center -mt-18 px-4 sm:px-6 lg:px-8">
            ...
            >
                ...
                <defs>
                    <radialGradient id="a" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="rotate(90 428 292)scale(812)">
                        <stop offset=".63" stopColor="#d0bae9ff" stopOpacity="0" />
                        <stop offset="1" stopColor="#d0bae9ff" />
                    </radialGradient>
                </defs>
            </motion.svg>
            ...
            >
               {/* sub heading */}
               Our UI/UX and product design services create intuitive, scalable digital experiences.Designed for usability, consistency, and long-term growth.
                    ...
                    <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold text-center mx-auto">Overview</h1>
                        ...
                        <section className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 md:gap-10 mt-10 sm:mt-12 md:mt-15">
                            ...
                            <div className="text-xs sm:text-sm text-slate-600 max-w-lg order-1 lg:order-2">
                                <h1 className="text-lg sm:text-xl md:text-2xl uppercase font-semibold text-white leading-relaxed">Our Design Philosophy</h1>
                                <div className="w-32 sm:w-36 md:w-40 h-[2px] sm:h-[3px] rounded-full bg-gradient-to-r from-indigo-600 to-[#DDD9FF]"></div>
                                <p className="mt-4 sm:mt-6 md:mt-8 text-white leading-relaxed">Designing systems that think, adapt, and convert.</p>
                                <p className="mt-3 sm:mt-4 text-white leading-relaxed">At Nexvity, we don't design screens ,We architect intelligent ecosystems. Our Circular Intelligence Workflow ensures that every pixel has intent and every interaction feels instinctive.</p>
                                <p className="mt-3 sm:mt-4 text-white leading-relaxed">Our process ensures that each product is:</p>
                                 <ul className="list-disc list-inside mt-2 text-white leading-relaxed space-y-1">
                                    ...
                                    <li>Functionally scalable</li>
                                    <li>Aligned with your brand and market</li>
                                 </ul>
                                 <p className="mt-3 sm:mt-4 text-white leading-relaxed">To us, design is the process of making innovation usable.</p>
                    ...
                    <section>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8 mt-6 sm:mt-8 md:mt-10 lg:mt-12">
                                ...
                                >
                                    ...
                                    <p className="text-xs sm:text-sm md:text-base leading-relaxed px-4 sm:px-5 md:px-6 pb-6 sm:pb-7 md:pb-8 text-slate-300">
                                        Bring your ideas to life with precise prototypes and wireframes that define the structure, flow, and functionality of your digital product. We help visualize concepts early, enabling faster feedback, smarter iterations, and a seamless development process.
                                    </p>
                                </div>
                                ...
                                >
                                    ...
                                    <p className="text-xs sm:text-sm md:text-base leading-relaxed px-4 sm:px-5 md:px-6 pb-6 sm:pb-7 md:pb-8 text-slate-300">
                                        We craft responsive, user-friendly web apps and websites that combine functionality with stunning design. Every interface is tailored to engage your audience, enhance usability, and drive business growth.
                                    </p>
                                </div>
                                ...
                                >
                                    ...
                                    <p className="text-xs sm:text-sm md:text-base leading-relaxed px-4 sm:px-5 md:px-6 pb-6 sm:pb-7 md:pb-8 text-slate-300">
                                        Our mobile app designs prioritize intuitive experiences, smooth navigation, and adaptive layouts. We create visually compelling apps that work seamlessly across iOS and Android, keeping your users engaged and satisfied.
                                    </p>
                                </div>
                                <div
                                    className="rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl overflow-hidden transition-transform duration-200 ease-out cursor-pointer bg-white/5 h-full min-h-[320px] sm:min-h-[360px] border border-indigo-400/40"
                                ...
                                >
                                    ...
                                    <p className="text-xs sm:text-sm md:text-base leading-relaxed px-4 sm:px-5 md:px-6 pb-6 sm:pb-7 md:pb-8 text-slate-300">
                                        Elevate your brand with cohesive identity design and creative services that resonate. From logos and visual assets to design systems, we ensure your brand communicates your values with clarity, consistency, and style.
                                    </p>
                                </div>
                            </div>
                        </div>
                       ...
                       <div className="mt-8 sm:mt-10 md:mt-12">
                         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-2">
                           ...
                           >
                             <div className={`relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] rounded-2xl sm:rounded-3xl ${
                               ...
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex flex-col items-center justify-center rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur border border-white/10 p-4 sm:p-5 md:p-6">
                                 ...
                                 <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-center text-white leading-relaxed">Cognitive Discovery & Data Intelligence</h3>
                                 <p className="mt-1.5 sm:mt-2 text-slate-300 text-xs sm:text-sm max-w-xs mx-auto text-center leading-relaxed">Most agencies begin with inspiration.We begin with behavioral truth.</p>
                               </div>
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex items-center justify-center rounded-2xl sm:rounded-3xl bg-indigo-600 text-white [transform:rotateY(180deg)] p-3 sm:p-4 text-center">
                                 <p className="text-xs sm:text-sm text-left leading-relaxed">Through advanced psychological profiling and data mining, we uncover User Shadows the unspoken motivations, frictions, and decision triggers that traditional research misses. These insights allow us to map interface behavior directly to your business KPIs.</p>
                               </div>
                             </div>
                           </motion.div>
                           <motion.div
                           ...
                           >
                             <div className={`relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] rounded-2xl sm:rounded-3xl ${
                               flippedCards['wireframe'] ? '[transform:rotateY(180deg)]' : ''
                             }`}>
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex flex-col items-center justify-center rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur border border-white/10 p-4 sm:p-5 md:p-6">
                                 <div className="mx-auto size-12 sm:size-14 md:size-16 rounded-full bg-gradient-to-br from-indigo-600 to-violet-500 p-0.5">
                                   <div className="size-full rounded-full bg-slate-900 text-white flex items-center justify-center">
                                 ...
                                 <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-white text-center leading-relaxed">Narrative Wireframing</h3>
                                 <p className="mt-1.5 sm:mt-2 text-slate-300 text-xs sm:text-sm max-w-xs mx-auto text-center leading-relaxed">Navigation should never feel like a task it should feel inevitable.</p>
                               </div>
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex items-center justify-center rounded-2xl sm:rounded-3xl bg-indigo-600 text-white [transform:rotateY(180deg)] p-3 sm:p-4 text-center">
                                 <p className="text-xs sm:text-sm text-left leading-relaxed">We approach wireframes as structural narratives, guiding users through a carefully engineered journey. Using Interaction Math, we design micro moments transitions, pauses, and visual cues—that subtly lead attention toward the Success Path.</p>
                               </div>
                             </div>
                           </motion.div>
                           <motion.div
                           ...
                           >
                             <div className={`relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] rounded-2xl sm:rounded-3xl ${
                               ...
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex flex-col items-center justify-center rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur border border-white/10 p-4 sm:p-5 md:p-6">
                                 ...
                                 <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-white text-center leading-relaxed"> High-Fidelity Design Systems</h3>
                                 <p className="mt-1.5 sm:mt-2 text-slate-300 text-xs sm:text-sm max-w-xs mx-auto text-center leading-relaxed">We don't create static interfaces.We build living systems.</p>
                               </div>
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex items-center justify-center rounded-2xl sm:rounded-3xl bg-indigo-600 text-white [transform:rotateY(180deg)] p-3 sm:p-4 text-center">
                                 <p className="text-xs sm:text-sm text-left leading-relaxed">By combining Atomic Design principles, Figma variables, and a centralized Design Language including our signature Sky Blue Neon accents we ensure your product scales seamlessly across devices, teams, and future iterations.</p>
                               </div>
                             </div>
                           </motion.div>
                           <motion.div
                           ...
                           >
                             <div className={`relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] rounded-2xl sm:rounded-3xl ${
                               ...
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex flex-col items-center justify-center rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur border border-white/10 p-4 sm:p-5 md:p-6">
                                 ...
                                 <h3 className="mt-3 sm:mt-4 text-base sm:text-lg font-semibold text-white text-center leading-relaxed">Stress Testing & Precision Handoff</h3>
                                 <p className="mt-1.5 sm:mt-2 text-slate-300 text-xs sm:text-sm max-w-xs mx-auto text-center leading-relaxed">Design is only successful when it survives reality.</p>
                               </div>
                               <div className="absolute w-full h-full [backface-visibility:hidden] flex items-center justify-center rounded-2xl sm:rounded-3xl bg-indigo-600 text-white [transform:rotateY(180deg)] p-3 sm:p-4 text-center">
                                 <p className="text-xs sm:text-sm text-left leading-relaxed">We simulate real world conditions poor lighting, low battery, slow networks to test resilience and clarity. Our developer handoff is engineered for precision, delivering design tokens, animation timings, and system logic that translate the vision into a flawless build.</p>
                               </div>
                             </div>
                           </motion.div>
                         </div>
                               ...
                               {sectionData.map((data, index) => (
                                 ...
                                 >
                                  ...
                                  {/* Technology marquee (auto-run right-to-left, pause on hover) */}
                                         <div className="w-full mb-6 sm:mb-8 mt-12 sm:mt-16 md:mt-20 px-4 sm:px-6 lg:px-8">
                                             <style jsx>{` 
                                             ...
                                             `}</style>
                                             <h1 className="text-xl sm:text-2xl md:text-3xl font-semibold text-center text-amber-50 mb-4 sm:mb-6">Technologies We Work With</h1>
                                             <div className="overflow-hidden w-full relative max-w-6xl mx-auto mt-8 sm:mt-12 md:mt-15" onMouseEnter={() => setStopScroll(true)} onMouseLeave={() => setStopScroll(false)}>
                                                     ...
                                                     <div className="flex">
                                                         {[...cardData, ...cardData].map((card, idx) => (
                                                             <div key={idx} className="w-36 sm:w-40 md:w-44 mx-2 sm:mx-3 p-2 sm:p-3 bg-slate-900/40 rounded-lg flex flex-col items-center text-center">
                                                                 <img src={card.image} alt={card.title} className="w-10 h-10 sm:w-12 sm:h-12 object-contain mb-1.5 sm:mb-2" />
